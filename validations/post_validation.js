    ...
    return {
        ...
        create_post : {
            payload: {
                ...
                post_by: Joi.string().required().example('xyz_pqr').description('This will be the username who is posting the comment'),
                ...
                //tags: Joi.string().example('xyz##118989').description('This will be the username to whom we want to tag'),
